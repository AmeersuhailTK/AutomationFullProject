...
import BrowserSetup.loginPageInsurence;
...
public class testInsurenceLog extends loginPageInsurence{
	...
	public void register() {
		...
		WebElement mup = driver.findElement(By.id("ui-id-2"));
		mup.click();
		Actions mv = new Actions(driver);
		mv.scrollByAmount(0, 500).perform();
		...
		driver.findElement(By.id("user[title]")).sendKeys("Jo");
